...
function(doctest_force_implementation exe_name lib_name)
    set(exe_dir ${CMAKE_CURRENT_BINARY_DIR}/${exe_name}_generated_sources)
    file(MAKE_DIRECTORY ${exe_dir})
    file(WRITE ${exe_dir}/doctest_impl.cpp "#define DOCTEST_CONFIG_IMPLEMENT\n#include <doctest/doctest.h>\n")
    target_sources(${exe_name} PRIVATE ${exe_dir}/doctest_impl.cpp)
    doctest_force_link_static_lib_in_target(${exe_name} ${lib_name})
endfunction()
