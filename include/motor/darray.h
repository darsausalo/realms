...
#define darr_push(a, v) (_mt_damgrow(a, 1), (a)[_mt_dan(a)++] = (v))
#define darr_count(a) ((a) ? _mt_dan(a) : 0)
#define darr_add(a, n)                                                         \
    (_mt_damgrow(a, n), _mt_dan(a) += (n), &(a)[_mt_dan(a) - (n)])
...
#define _mt_darr_needgrow(a, n)                                                \
    ((a) == 0 || _mt_darr_n(a) + (n) >= _mt_darr_m(a))
#define _mt_darr_maybegrow(a, n)                                               \
    (_mt_darr_needgrow(a, (n)) ? _mt_darr_grow(a, n) : 0)
#define _mt_darr_grow(a, n)                                                    \
    (*((void**) &(a)) = _mt_darr_growf((a), (n), sizeof(*(a))))

static void* _mt_dagrowf(void* arr, int increment, int itemsize) {
